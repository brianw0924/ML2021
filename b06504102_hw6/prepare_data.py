...
def resize_multiple(img, sizes=(8, 16, 32, 64), quality=100):
    imgs = []
...
def prepare(transaction, dataset, n_worker, sizes=(8, 16, 32, 64)):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out', type=str, default = "./dataset_lmdb")
